...
namespace Luqma.Service.Interfaces
{
    ...
    {
        public Task<(string, IList<GetSalariesResponse>?)> GenerateSalaryAsync();
        public Task<(string, GetSalariesResponse?)> GenerateSalaryForUserAsync(int userId, int? year = 0, int? month = 0);
